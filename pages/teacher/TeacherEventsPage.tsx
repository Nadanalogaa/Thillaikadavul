...
const TeacherEventsPage: React.FC = () => {
    ...
    return (
        <DashboardHeader 
            ...
            pageSubtitle="Stay updated with events, workshops, and activities related to your courses"
        >
            <div className="px-6">
                            ...
                            {currentEvents.map((event, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`relative rounded-2xl p-8 border shadow-sm transition-all duration-500 overflow-hidden group ${
                                            theme === 'dark'
