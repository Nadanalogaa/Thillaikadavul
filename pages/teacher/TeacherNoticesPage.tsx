    ...
    useEffect(() => {
        const fetchNotices = async () => {
            ...
            try {
                ...
                console.log('Loading notices data for teacher:', user.name);
                            ...
                            {currentNotices.map((notice, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`relative p-6 rounded-2xl border shadow-sm transition-all duration-300 cursor-pointer group ${
                                            isRead
                                                ? theme === 'dark'
                                                    ? 'bg-gray-800 border-gray-700'
                                                    : 'bg-white border-gray-200'
                                                : theme === 'dark'
                                                    ? 'bg-gray-800 border-gray-700 ring-2 ring-indigo-500/30'
                                                    : 'bg-white border-gray-200 ring-2 ring-indigo-500/30'
                                        } ${typeBg}`}
                                    >
                                        {/* Unread indicator */}
                                        {!isRead && (
