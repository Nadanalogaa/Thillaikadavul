...
const StudentsIcon = () => <IconWrapper><path d="M17 21v-2a4 4 0 00-3-3.87M7 21v-2a4 4 0 013-3.87M9 7a4 4 0 108 0 4 4 0 00-8 0zm-6 4a4 4 0 118 0 4 4 0 01-8 0z" /></IconWrapper>;
const BatchesIcon = () => <IconWrapper><path d="M3 7l9-4 9 4-9 4-9-4zm0 6l9 4 9-4M3 7v6m18-6v6M3 13v6l9 4 9-4v-6" /></IconWrapper>;
...
const Sidebar: React.FC<{ onLogout: () => void }> = ({ onLogout }) => {
    ...
    const NAV_ITEMS = [
        ...
        { name: 'Batches', path: 'batches', icon: BatchesIcon },
        ...
        { name: 'Fees', path: 'fees', icon: PaymentHistoryIcon },
