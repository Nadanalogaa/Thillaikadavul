...
import EnhancedHomepageCMS from './pages/admin/EnhancedHomepageCMS';
    ...
    <div className="flex flex-col min-h-screen bg-brand-light/20">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route path="/admin/cms" element={<AdminProtectedRoute><EnhancedHomepageCMS /></AdminProtectedRoute>} />
